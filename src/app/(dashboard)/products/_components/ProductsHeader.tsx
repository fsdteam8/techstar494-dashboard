...
export default function ProductsHeader({ onAddProductClick }: ProductsHeaderProps) {
    return (
        <div className="w-full flex items-center justify-between">
            ...
            <div>
            <Button className="ml-auto bg-[#6B46C1] text-white h-[48px] rounded-[8px]"  onClick={onAddProductClick}>
                Add product
            </Button>
            </div>
