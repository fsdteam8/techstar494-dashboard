    ...
    <div className="w-full flex items-center justify-start">
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/documents/privacy-policy" className="hover:underline hover:text-primary font-medium">
            <p className="text-sm text-[#4B5563] leading-[120%] font-normal pt-2">
              Privacy Policy
            </p>
          </Link>
...
export default AddPrivacyPolicyHeader;
